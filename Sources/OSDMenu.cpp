...
{
	Color LimeGreen1(50, 205, 50);
	std::string limegreen1 = "" << LimeGreen1 << "";
    ...
    bool     OSDMenu_Draw(const Screen &screen)
    {
        ...
        {
            screen.Draw(menu._title, posX, posY, Color(LimeGreen1));
            screen.DrawRect(posX, posY + 10, (Utils::GetSize(menu._title) + 3) * 6, 1, Color(LimeGreen1), false);
        }
